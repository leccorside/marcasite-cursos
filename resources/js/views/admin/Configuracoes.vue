<template>
  <div class="p-4 md:p-8 max-w-2xl mx-auto">
    <h1 class="text-2xl md:text-3xl font-black text-black uppercase tracking-tighter mb-8">Configurações Administrativas</h1>
      ...
      <div class="p-8">
        <form @submit.prevent="salvarPerfil" class="space-y-6">
          ...
          <div class="flex flex-col items-center mb-10 pb-10 border-b border-gray-100">
            <h3 class="text-xs font-black text-gray-400 uppercase tracking-widest mb-4 self-start">Sua Foto</h3>
            <div 
          ...
          <!-- Email -->
          <div>
            <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">E-mail Administrativo</label>
            <input
              v-model="form.email"
              type="email"
              ...
              disabled
            />
            <p class="mt-1 text-[10px] text-gray-400 font-bold italic">O e-mail de acesso não pode ser alterado por aqui.</p>
          </div>

          <!-- Alterar Senha -->
          <div class="pt-4 border-t border-gray-100">
            <h3 class="text-sm font-black text-black uppercase tracking-widest mb-4">Segurança</h3>
            <div class="space-y-4">
              <div>
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full bg-[#333] text-white py-4 px-6 rounded-xl font-black uppercase tracking-widest hover:bg-black transition-all shadow-lg disabled:opacity-50"
          >
...
const salvarPerfil = async () => {
  ...
  try {
    ...
    mensagem.value = 'Configurações atualizadas com sucesso!';
    ...
    if (error.response?.status === 422) {
      ...
      mensagem.value = error.response?.data?.message || 'Erro ao atualizar configurações';
